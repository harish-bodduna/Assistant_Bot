"""Generate llm_ready_sas_markdown from MFA PDF and write to disk for manual editing."""
import os
import io
...
def generate_mfa_markdown():
    """Process MFA PDF and generate llm_ready_sas_markdown, write to disk."""
    
    # Path to source PDF
    pdf_path = Path("source_docs/1440-Microsoft Multifactor Authentication Documentation.pdf")
    ...
    output_dir = Path("markdown_exports/mfa_manual_edit")
    output_dir.mkdir(parents=True, exist_ok=True)
    
    # Write markdown to file
    output_file = output_dir / "llm_ready_sas_markdown.md"
    ...
    summary_content = f"""MFA Markdown Generation Summary
===============================
