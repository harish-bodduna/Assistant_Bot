"""Generate llm_ready_sas_markdown from WiFi Guide PDF and write to disk for manual editing."""
import os
import io
...
def generate_wifi_guide_markdown():
    """Process WiFi Guide PDF and generate llm_ready_sas_markdown, write to disk."""

    # Path to source PDF
    pdf_path = Path("source_docs/1440 Foods WiFi Guide.pdf")
    ...
    output_dir = Path("markdown_exports/wifi_guide_manual_edit")
    output_dir.mkdir(parents=True, exist_ok=True)

    # Write markdown to file
    output_file = output_dir / "wifi_guide_llm_ready_markdown.md"
    ...
    summary_content = f"""WiFi Guide Markdown Generation Summary
====================================
