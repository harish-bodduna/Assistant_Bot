"""Generate llm_ready_sas_markdown from External SharePoint PDF and write to disk for manual editing."""
import os
import io
...
def generate_external_sharepoint_markdown():
    """Process External SharePoint PDF and generate llm_ready_sas_markdown, write to disk."""

    # Path to source PDF
    pdf_path = Path("source_docs/External SharePoint access.pdf")
    ...
    output_dir = Path("markdown_exports/external_sharepoint_manual_edit")
    output_dir.mkdir(parents=True, exist_ok=True)

    # Write markdown to file with the specified filename
    output_file = output_dir / "external_sharepoint_llm_ready_markdown.md"
    ...
    summary_content = f"""External SharePoint Markdown Generation Summary
==============================================
...
if __name__ == "__main__":
    generate_external_sharepoint_markdown()