"""Generate llm_ready_sas_markdown from Barracuda Backup PDF and write to disk for manual editing."""
import os
import io
...
def generate_barracuda_backup_markdown():
    """Process Barracuda Backup PDF and generate llm_ready_sas_markdown, write to disk."""

    # Path to source PDF
    pdf_path = Path("source_docs/Barracuda Backup Policy v1.0.pdf")
    ...
    output_dir = Path("markdown_exports/barracuda_backup_manual_edit")
    output_dir.mkdir(parents=True, exist_ok=True)

    # Write markdown to file
    output_file = output_dir / "barracuda_backup_llm_ready_markdown.md"
    ...
    summary_content = f"""Barracuda Backup Markdown Generation Summary
=============================================
...
if __name__ == "__main__":
    generate_barracuda_backup_markdown()